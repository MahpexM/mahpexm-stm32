\doxysection{stm32f10x\+\_\+pwr.\+c File Reference}
\hypertarget{stm32f10x__pwr_8c}{}\label{stm32f10x__pwr_8c}\index{stm32f10x\_pwr.c@{stm32f10x\_pwr.c}}
...
\item 
\#define {\bfseries PWR\+\_\+\+OFFSET}~(PWR\+\_\+\+BASE -\/ PERIPH\+\_\+\+BASE)
\item 
\#define {\bfseries CR\+\_\+\+OFFSET}~(PWR\+\_\+\+OFFSET + 0x00)
\item 
\#define {\bfseries DBP\+\_\+\+Bit\+Number}~0x08
\item 
\#define {\bfseries CR\+\_\+\+DBP\+\_\+\+BB}~(PERIPH\+\_\+\+BB\+\_\+\+BASE + (CR\+\_\+\+OFFSET \texorpdfstring{$\ast$}{*} 32) + (DBP\+\_\+\+Bit\+Number \texorpdfstring{$\ast$}{*} 4))
\item 
\#define {\bfseries PVDE\+\_\+\+Bit\+Number}~0x04
\item 
\#define {\bfseries CR\+\_\+\+PVDE\+\_\+\+BB}~(PERIPH\+\_\+\+BB\+\_\+\+BASE + (CR\+\_\+\+OFFSET \texorpdfstring{$\ast$}{*} 32) + (PVDE\+\_\+\+Bit\+Number \texorpdfstring{$\ast$}{*} 4))
\item 
\#define {\bfseries CSR\+\_\+\+OFFSET}~(PWR\+\_\+\+OFFSET + 0x04)
\item 
\#define {\bfseries EWUP\+\_\+\+Bit\+Number}~0x08
\item 
\#define {\bfseries CSR\+\_\+\+EWUP\+\_\+\+BB}~(PERIPH\+\_\+\+BB\+\_\+\+BASE + (CSR\+\_\+\+OFFSET \texorpdfstring{$\ast$}{*} 32) + (EWUP\+\_\+\+Bit\+Number \texorpdfstring{$\ast$}{*} 4))
\item 
