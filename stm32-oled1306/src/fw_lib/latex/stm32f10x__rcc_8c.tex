\doxysection{stm32f10x\+\_\+rcc.\+c File Reference}
\hypertarget{stm32f10x__rcc_8c}{}\label{stm32f10x__rcc_8c}\index{stm32f10x\_rcc.c@{stm32f10x\_rcc.c}}
...
\item 
\#define {\bfseries CFGR\+\_\+\+USBPRE\+\_\+\+BB}~(PERIPH\+\_\+\+BB\+\_\+\+BASE + (CFGR\+\_\+\+OFFSET \texorpdfstring{$\ast$}{*} 32) + (USBPRE\+\_\+\+Bit\+Number \texorpdfstring{$\ast$}{*} 4))
\item 
